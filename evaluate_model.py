...
def evaluate_model(label_folder, output_folder):
    ...
    outcome_scores = (
        ...
        outcome_auroc,
        outcome_auprc,
        outcome_auroc_classes,
        outcome_auprc_classes,
        outcome_f_measure,
        outcome_f_measure_classes,
        outcome_accuracy,
        outcome_accuracy_classes,
        outcome_weighted_accuracy,
        outcome_cost,
    )
    ...
    for label_file in sorted(os.listdir(label_folder)):
        ...
        if (
            ...
            if os.path.isfile(output_file_path):
                ...
                raise IOError(
                    "Output file {} not found for label file {}.".format(output_file, label_file)
                )
